...
options.register('doBPIX5',
    ...
    mytype = VarParsing.VarParsing.varType.bool,
    info = "set doBPIX5")
# Set doEvtSeljetDijetTau to 1
options.register('doEvtSeljetDijetTau',
    default = True,
    mult = VarParsing.VarParsing.multiplicity.singleton,
    mytype = VarParsing.VarParsing.varType.bool,
    info = "set doEvtSeljetDijetTau")
...
process.JetFrames.doEvtSeljetDijetTau = options.doEvtSeljetDijetTau
...
process.DetFrames.doEvtSeljetDijetTau = options.doEvtSeljetDijetTau
