...
class DetFrameProducer : public edm::stream::EDProducer<> {
   ...
   private:
      ...
      static const unsigned nJets_tau = 10;
      ...
      vector<float> v_tau_subJetE_[nJets_tau];
      vector<float> v_tau_subJetPx_[nJets_tau];
      vector<float> v_tau_subJetPy_[nJets_tau];
      vector<float> v_tau_subJetPz_[nJets_tau];
      vector<int> vJetIdxs;
      ...
      void fillEvtSeljetDijetTau ( const edm::Event&, const edm::EventSetup&);
      void branchesEvtSeljetDijetTau (TTree*, edm::Service<TFileService> &);
      bool runEvtSeljetDijetTau( const edm::Event&, const edm::EventSetup&);
